CREATE OR REPLACE PROCEDURE `bigquery-learning-405922.airbnb.count_procedure`(
...
-- Ejemplo de uso
CALL `bigquery-learning-405922.airbnb.count_procedure`('bigquery-learning-405922.airbnb.reviews_p', 2018, 1);
